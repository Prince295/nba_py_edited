from nba_py import _api_scrape, _get_json, _api_scrape1, _api_scrape2
...
class TeamStatsByClucth:
    _endpoint = 'leaguedashteamclutch'

    def __init__(self,
                 clutch_time = ClutchTime.Last5Min,
                 ahead_behind = AheadBehind.AheadOrBehind,
...
class _TeamTrackingStats:
    ...
    def __init__(self,                 
                 ...
                 height=Height.Default,
                 weight=Weight.Default,
                 distance_range = DistanceRange.ByZone,
                 game_segment = GameSegment.Default
                 ):
    ...
    def overall(self):
        return _api_scrape2(self.json, 0)
...
class _PlayerTrackingStats:
    ...
    def overall(self):
        return _api_scrape1(self.json, 0)
